...
Функция ПолучитьOpenApiСхему(Схема) Экспорт
    ...
    Если Схема.Внешняя И РегистрыСведений.инт_КэшированиеСхемOpenApi.ТребуетсяОбновление(Схема) Тогда
        ...
        ЭлементБлокировки = Блокировка.Добавить("Справочник.инт_Схемы");
        ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
        ЭлементБлокировки.УстановитьЗначение("Ссылка", Схема);
        ЭлементБлокировки = Блокировка.Добавить("Регистрсведений.инт_КэшированиеСхемOpenApi");
        ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
        ЭлементБлокировки.УстановитьЗначение("СсылкаНаСхему", Схема);
