...
Функция СформироватьСообщениеПоПотоку(ИсходныеДанные, ПотокДанных) Экспорт
    ...
    Попытка
        ПутьEPF = инт_ГенераторОбработокПовтИсп.ПутьЕПФПотока(ПотокДанных);
        СформированноеСообщение = Исполнить(ПутьEPF, ИсходныеДанные);
    Исключение
...
Процедура ОбработатьВходящееСообщениеПоПотоку(СоответствиеСообщения, ПотокДанных, РазрешитьФиксациюИзменений = Истина) Экспорт
    ...
    Попытка
        ПутьEPF = инт_ГенераторОбработокПовтИсп.ПутьЕПФПотока(ПотокДанных);
        Исполнить(ПутьEPF, СоответствиеСообщения, РазрешитьФиксациюИзменений);
    Исключение
...
Функция Исполнить(ДвоичныеДанныеИлиПутьEPF, ИсходныеДанные, РазрешитьФиксациюИзменений = Ложь)
    
    Возврат инт_ГенераторОбработок.ИсполнитьОбработку(ДвоичныеДанныеИлиПутьEPF, ИсходныеДанные, РазрешитьФиксациюИзменений);
