...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
    Если ТекущийОбъект.ДополнительныеСвойства.Свойство("ЗарегистрироватьОбработанныеСообщенияКУдалению") Тогда
        инт_СервисныеДействия.ЗапуститьРегистрациюОбработанныхСообщенийПотока(ТекущийОбъект.Ссылка);
    КонецЕсли;
КонецПроцедуры
