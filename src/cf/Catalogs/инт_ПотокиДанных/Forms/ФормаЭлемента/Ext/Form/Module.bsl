...
Процедура ОпределитьОтслеживаемыеРеквизиты(Команда)
	ДопПараметры = Новый Структура("ОтслеживаемыеРеквизиты, СсылкаНаОбъект", Объект.ОтслеживаемыеРеквизиты, Объект.Пример);
...
Процедура ПерезаполнитьОтслеживаемыеРеквизиты()
	...
	Объект.ОтслеживаемыеРеквизиты = ЗначениеВСтрокуВнутр(Справочники.инт_ПотокиДанных.ЗаполнитьДеревоРеквизитовПоСсылке(Объект.Пример, ИсходныеДанные));
...
Процедура ВизуальныеНастройкиЭлементовФормСвязанныхСОтслеживаемымиРеквизитами()
	...
	КонецЕсли;
	Элементы.ОпределитьОтслеживаемыеРеквизиты.Доступность = ЗначениеЗаполнено(Объект.Пример);
КонецПроцедуры
