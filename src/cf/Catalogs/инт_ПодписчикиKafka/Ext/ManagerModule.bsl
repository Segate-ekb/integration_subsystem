...
Процедура ОтправитьСообщение(Сообщение, ОтложенныеДействия) Экспорт
    ...
    Иначе
        ...
        инт_РаботаСКафка.ОтправитьСообщение(Сообщение.СформированноеСообщение, Брокеры, ИмяТопика, , , , ТипСжатия, Подписчик.Эндпоинт);
    КонецЕсли;
...
Процедура ОтправитьПакет(Подписчик, МассивСообщений) Экспорт
    ...
    Брокеры = Подписчик.Эндпоинт.АдресРесурса;
    ТипСжатия = Подписчик.ТипСжатия;
	инт_РаботаСКафка.ОтправитьСообщенияПакетом(МассивСообщений, Брокеры, Подписчик.ИмяТопика, ТипСжатия, Подписчик.Эндпоинт);
КонецПроцедуры
