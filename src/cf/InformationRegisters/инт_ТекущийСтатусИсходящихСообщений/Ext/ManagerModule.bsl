...
Функция ПолучитьИдентификаторыСообщенийКФормированию(Количество = 0) Экспорт
    ...
    Запрос.Текст = СтрШаблон("ВЫБРАТЬ %1
                   ...
                   |    И инт_ТекущийСтатусИсходящихСообщений.ДатаСледующейПопытки <= &ТекущийМомент
                   |;
                   |
                   |////////////////////////////////////////////////////////////////////////////////
                   |ВЫБРАТЬ %1
...
Функция РасчитатьДатуСледующейПопытки(ИдентификаторСообщения)
    Возврат Справочники.инт_ПотокиДанных.РасчитатьДатуСледующейПопыткиПоДате(инт_ОбщегоНазначения.ВремяБазы(),
