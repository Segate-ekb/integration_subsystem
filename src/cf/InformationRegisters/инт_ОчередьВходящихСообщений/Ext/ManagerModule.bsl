...
Процедура ОбработатьСообщениеПоИдентификатору(ИдентификаторСообщения) Экспорт
    ...
    Попытка
        ...
        РегистрыСведений.инт_СтатистикаОбработкиСообщений.ЗаписатьСтатистикуОбработкиВходящего(ИдентификаторСообщения, СообщениеВОчереди.ПотокДанных, ДлительностьМс, Истина);
    Исключение
        ОтменитьТранзакцию();
        ДлительностьМс = ТекущаяУниверсальнаяДатаВМиллисекундах() - ВремяНачала;
        РегистрыСведений.инт_СтатистикаОбработкиСообщений.ЗаписатьСтатистикуОбработкиВходящего(ИдентификаторСообщения, СообщениеВОчереди.ПотокДанных, ДлительностьМс, Ложь);
