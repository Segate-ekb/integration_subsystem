...
Функция ЗарегистрироватьСообщение(ВходящееСообщение, ПотокДанных, Знач ИдентификаторСообщения = Неопределено) Экспорт
    ...
    Попытка
        ...
        Запись.ДатаСоздания = инт_ОбщегоНазначения.ВремяБазы();
        Запись.Записать();
