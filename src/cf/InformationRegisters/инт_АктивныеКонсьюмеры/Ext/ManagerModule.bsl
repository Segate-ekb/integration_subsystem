...
Процедура ЗарегистрироватьКонсьюмер(Подписка, ИдентификаторФоновогоЗадания, СтатусАктивности = "Активен") Экспорт
	...
	Запись.ВремяЗапуска = инт_ОбщегоНазначения.ВремяБазы();
	Запись.ПоследняяАктивность = инт_ОбщегоНазначения.ВремяБазы();
...
Процедура ОбновитьАктивность(Подписка, ИдентификаторФоновогоЗадания) Экспорт
	...
	Если НаборЗаписей.Количество() > 0 Тогда
		НаборЗаписей[0].ПоследняяАктивность = инт_ОбщегоНазначения.ВремяБазы();
		НаборЗаписей.Записать();
	КонецЕсли;
