...
Функция ИмяТипа(Тип, ДополнительныеПараметры)
	...
	Иначе
		...
		Иначе
			...
			Результат = ИТК_МетаданныеКлиентСервер.ТипСсылка(ИмяОбъектаКоллекции, ОбъектМетаданных.Имя, Язык);
...
Функция ЗначениеСсылка(Значение, ДополнительныеПараметры, Комментарий)
	...
	ПолноеИмяМетаданных = ИТК_Метаданные.ПолноеИмя(ОбъектМетаданных, Язык);
