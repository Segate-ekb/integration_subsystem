...
Функция ПолучитьРезультат(Параметры, АдресРезультата = Неопределено) Экспорт
	...
	Попытка
		...
		ИТК_ДлительныеОперации.СообщитьПрогресс(ИТК_Строки.ТекстЭтапаПроцесса(НСтр("ru = 'Получение схемы'; en = 'Getting the schema'"), Шаг, КоличествоШагов, ГлавнаяОперация));
		СхемаКомпоновкиДанных = СхемаКомпоновкиДанных(Данные.XMLСхемаКомпоновкиДанных);
		
		ИТК_ДлительныеОперации.СообщитьПрогресс(ИТК_Строки.ТекстЭтапаПроцесса(НСтр("ru = 'Инициализация внешних источников'; en = 'Initialization of external sources'"), Шаг, КоличествоШагов, ГлавнаяОперация));
	
		// Начало замера времени выполнения --------------------------------------------------------------------------------- {
		НачалоЗамера = ТекущаяУниверсальнаяДатаВМиллисекундах();
		
		ИТК_ДлительныеОперации.СообщитьПрогресс(ИТК_Строки.ТекстЭтапаПроцесса(НСтр("ru = 'Компоновка макета'; en = 'Layout layout'"), Шаг, КоличествоШагов, ГлавнаяОперация));
		...
		ИТК_ДлительныеОперации.СообщитьПрогресс(ИТК_Строки.ТекстЭтапаПроцесса(НСтр("ru = 'Выполнение'; en = 'Executing'"), Шаг, КоличествоШагов, ГлавнаяОперация));
		...
		Если ВыводРезультата Тогда
			...
			ИТК_ДлительныеОперации.СообщитьПрогресс(ИТК_Строки.ТекстЭтапаПроцесса(НСтр("ru = 'Вывод результата'; en = 'The output'"), Шаг, КоличествоШагов, ГлавнаяОперация));
