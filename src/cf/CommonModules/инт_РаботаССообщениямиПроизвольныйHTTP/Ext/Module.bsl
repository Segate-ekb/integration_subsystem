...
Процедура ОтправитьСообщение(Сообщение) Экспорт
	...
	url = СформироватьURLПоДаннымПодписчика(СтруктураПараметровСоединения.АдресРесурса, Подписчик, ДанныеИсходящегоСообщения);
...
Функция СформироватьURLПоДаннымПодписчика(Знач url, Подписчик, ДанныеИсходящегоСообщения)
