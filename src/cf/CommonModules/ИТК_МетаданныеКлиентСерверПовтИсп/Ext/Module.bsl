...
Функция Картинка(Имя) Экспорт
	...
	Если ЭтоПоследовательность(Имя) Тогда
		...
		Результат = БиблиотекаКартинок.ИТК_Последовательность;
		
	ИначеЕсли ЭтоТочкаМаршрутаБизнесПроцесса(Имя) Тогда
		
		Результат = БиблиотекаКартинок.ИТК_ТочкаМаршрутаБизнессПроцесса;
...
Функция ПорядокОбъектаКоллекции(Имя) Экспорт
	...
	ЯзыкАнглийский = ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский();
...
Функция ЭтоСправочник(Знач Имя) Экспорт
	...
	Возврат (Имя = ИмяОбъектаСправочник() ИЛИ Имя = ИмяОбъектаСправочник(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииСправочники() ИЛИ Имя = ИмяКоллекцииСправочники(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоДокумент(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаДокумент() ИЛИ Имя = ИмяОбъектаДокумент(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииДокументы() ИЛИ Имя = ИмяКоллекцииДокументы(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоБизнесПроцесс(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаБизнесПроцесс() ИЛИ Имя = ИмяОбъектаБизнесПроцесс(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииБизнесПроцессы() ИЛИ Имя = ИмяКоллекцииБизнесПроцессы(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоЗадача(Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаЗадача() ИЛИ Имя = ИмяОбъектаЗадача(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииЗадачи() ИЛИ Имя = ИмяКоллекцииЗадачи(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));

КонецФункции

Функция ЭтоОбщийМодуль(Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаОбщийМодуль() ИЛИ Имя = ИмяОбъектаОбщийМодуль(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииОбщиеМодули() ИЛИ Имя = ИмяКоллекцииОбщиеМодули(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));

КонецФункции

Функция ЭтоОбработка(Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаОбработка() ИЛИ Имя = ИмяОбъектаОбработка(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииОбработки() ИЛИ Имя = ИмяКоллекцииОбработки(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));

КонецФункции

Функция ЭтоОтчет(Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаОтчет() ИЛИ Имя = ИмяОбъектаОтчет(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииОтчеты() ИЛИ Имя = ИмяКоллекцииОтчеты(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));

КонецФункции

Функция ЭтоХранилищеНастроек(Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаХранилищеНастроек() ИЛИ Имя = ИмяОбъектаХранилищеНастроек(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));

КонецФункции

Функция ЭтоПланВидовХарактеристик(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаПланВидовХарактеристик() ИЛИ Имя = ИмяОбъектаПланВидовХарактеристик(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииПланыВидовХарактеристик() ИЛИ Имя = ИмяКоллекцииПланыВидовХарактеристик(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоПланВидовРасчета(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаПланВидовРасчета() ИЛИ Имя = ИмяОбъектаПланВидовРасчета(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииПланыВидовРасчета() ИЛИ Имя = ИмяКоллекцииПланыВидовРасчета(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоПланСчетов(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаПланСчетов() ИЛИ Имя = ИмяОбъектаПланСчетов(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииПланыСчетов() ИЛИ Имя = ИмяКоллекцииПланыСчетов(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоПланОбмена(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаПланОбмена() ИЛИ Имя = ИмяОбъектаПланОбмена(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииПланыОбмена() ИЛИ Имя = ИмяКоллекцииПланыОбмена(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоКритерийОтбора(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаКритерийОтбора() ИЛИ Имя = ИмяОбъектаКритерийОтбора(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииКритерииОтбора() ИЛИ Имя = ИмяКоллекцииКритерииОтбора(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоКонстанта(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаКонстанта() ИЛИ Имя = ИмяОбъектаКонстанта(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииКонстанты() ИЛИ Имя = ИмяКоллекцииКонстанты(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоЖурналДокументов(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаЖурналДокументов() ИЛИ Имя = ИмяОбъектаЖурналДокументов(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииЖурналыДокументов() ИЛИ Имя = ИмяКоллекцииЖурналыДокументов(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоПоследовательность(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаПоследовательность() ИЛИ Имя = ИмяОбъектаПоследовательность(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииПоследовательности() ИЛИ Имя = ИмяКоллекцииПоследовательности(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоТочкаМаршрутаБизнесПроцесса(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаТочкаМаршрутаБизнесПроцесса() ИЛИ Имя = ИмяОбъектаТочкаМаршрутаБизнесПроцесса(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииТочкиМаршрутаБизнесПроцесса() ИЛИ Имя = ИмяКоллекцииТочкиМаршрутаБизнесПроцесса(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
...
Функция ЭтоПеречисление(Знач Имя) Экспорт
	...
	Возврат (Имя = ИмяОбъектаПеречисление() ИЛИ Имя = ИмяОбъектаПеречисление(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииПеречисления() ИЛИ Имя = ИмяКоллекцииПеречисления(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
...
Функция ЭтоРегистрСведений(Знач Имя) Экспорт
	...
	Возврат (Имя = ИмяОбъектаРегистрСведений() ИЛИ Имя = ИмяОбъектаРегистрСведений(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииРегистрыСведений() ИЛИ Имя = ИмяКоллекцииРегистрыСведений(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));

КонецФункции

Функция ЭтоРегистрНакопления(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаРегистрНакопления() ИЛИ Имя = ИмяОбъектаРегистрНакопления(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииРегистрыНакопления() ИЛИ Имя = ИмяКоллекцииРегистрыНакопления(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоРегистрБухгалтерии(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаРегистрБухгалтерии() ИЛИ Имя = ИмяОбъектаРегистрБухгалтерии(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииРегистрыБухгалтерии() ИЛИ Имя = ИмяКоллекцииРегистрыБухгалтерии(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
	
КонецФункции

Функция ЭтоРегистрРасчета(Знач Имя) Экспорт
	
	Возврат (Имя = ИмяОбъектаРегистрРасчета() ИЛИ Имя = ИмяОбъектаРегистрРасчета(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский())
				ИЛИ Имя = ИмяКоллекцииРегистрыРасчета() ИЛИ Имя = ИмяКоллекцииРегистрыРасчета(ИТК_ОбщийКлиентСервер.КодЯзыкаАнглийский()));
...
Функция ОбщийМодуль(Имя) Экспорт
	...
	Если НЕ ИТК_МетаданныеВызовСервера.СуществуетОбщийМодуль(Имя) Тогда
