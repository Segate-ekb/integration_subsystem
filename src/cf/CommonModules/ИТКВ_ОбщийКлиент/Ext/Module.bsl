...
Процедура ОткрытьНастройки(Владелец = Неопределено, Инструмент = Неопределено, Раздел = Неопределено) Экспорт
	...
	ОткрытьФорму("ОбщаяФорма.ИТКВ_Настройки", Параметры, Владелец, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОткрытьЗапросИсточника(Владелец, Колонки, Источник) Экспорт
	...
	ОткрытьФорму("Обработка.ИТКВ_КонсольРазработчика.Форма.ЗапросИсточника", Параметры, Владелец, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
