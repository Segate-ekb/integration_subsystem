...
Процедура ЗаписьНеОшибочногоСтатусаСообщения() Экспорт
    ...
    СоздатьЗаписьВРегистреСПроверкой(ИдентификаторСообщения, Подписчик, Статус);
...
Процедура ЗаписьОшибочногоСтатусаСообщения() Экспорт
    ...
    СоздатьЗаписьВРегистреСПроверкой(ИдентификаторСообщения, Подписчик, Статус, Текст);
...
Процедура ПроверитьРаботуФункцииТекущийСтатусСообщения() Экспорт
    ...
    Статус = ГенераторТестовыхДанных.ОшибочныйСтатусРассылкиСообщений();
    СоздатьЗаписьВРегистреСПроверкой(ИдентификаторСообщения, Подписчик, Статус, ЮТест.Данные().СлучайнаяСтрока());
...
Процедура СоздатьЗаписьВРегистреСПроверкой(ИдентификаторСообщения, Подписчик, Статус, Текст = "")
 	    ЮТест.ОжидаетЧто(РегистрыСведений.инт_ТекущийСтатусРассылкиСообщений)
